...
<body style="background-color: #DCF5FF">
  ...
  <a class="navbar-brand" href="index.php" style="font-size: 35px;color: #eee;font-family: 'Source Sans Pro', sans-serif;margin-left: 30px;">Investment Plant </a>
    ...
    <ul class="navbar-nav ml-auto">
     ...
     <!-- slider start -->
        ...
        <!-- slider start -->
     	...
     	<div >
          <br>
          <div>You are here:  <a class="unorder" href="#">Home</a> / Contact Us</div>
        ...
        <address>
          ...
          <strong>BE AN INVESTER</strong><br>
            4, Opposite State Bank,<br>
           Azad Nagar,Andheri West<br>
            MUMBAI, MAHARASTRA(400058)<br><br><br><br><br><br><br><br><br><br><br><br>
