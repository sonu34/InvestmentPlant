...
<body>
    <div >
            ...
            <div class="container box">
              <div class="row">
                <div class="col-sm-6">
                  <form class="form-container" action="carquotationconn.php" method="post">
                <br><br>
            <h3>Get Quotation Now</h3>
                 ...
                 <div class="form-row mb-4">
                  ...
                  <div class="col">
                    ...
                    <label for="carname">Car Name:</label>
                      <input type="text" class="form-control" name="carname" placeholder="Car Name..." required>
                 </div>
                </div>
                ...
                <div class="form-row mb-4">
                  ...
                  <div class="col">
                    ...
                    <label for="carnumber">Car Number:</label>
                      <input type="text" class="form-control" name="carnumber" placeholder="MH01BB1234" required>
                 </div>
                </div>
                   ...
                   <div class="form-group">
                    ...
                    <select class="browser-default custom-select" id="instype" name="insurancetype">
                      ...
                      <option value="v03" id="v03">Own Damage</option>
                    </select>
                  </div>
                   ...
                   <div class="form-row mb-4">
                     ...
                     <div class="col">
                         ...
                         <div class="form-row md-4">
                           <div class="col">
                             <select class="browser-default custom-select" name="manumonth">
                 ...
                 <div class="form-row mb-4">
                     ...
                     <div class="col">
                         ...
                         <input placeholder="Company Name" type="text" id="" name="precompany" class="form-control" required>
                ...
                <div class="form-row mb-4" >
                     <div class="col" id="cpacov">
                      ...
                      <select class="browser-default custom-select" id="incdcpa" name="cpacover" required>
