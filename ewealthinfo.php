  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          ...
          <div class="dropdown-divider"></div>
          <a class="nav-link dropdown-item active" href="ewealthinfo.php"><strong>E-Wealth</strong></a>
          <div class="dropdown-divider"></div>
    ...
    <div class="container" style="background-color: white;">
     ...
     <!-- slider start -->
        ...
        <br>
          <div>You are here:  <a class="unorder" href="#">Home</a> / <a class="unorder" href="#">Technology</a> / E-Wealth</div>
        
        <hr>
     
       <h3 >E-Wealth</h3><hr>
       <h5>NJ E-Wealth Account (Trading & Demat Account): 'Freedom to Transact Anytime, Any where.</h5>
       Our clients can benefit greatly by subscribing to the the NJ Trading Account & Demat Account (TADA) service, which helps avoid the hassles & worries of doing physical transactions. NJ TADA offers convenience in making transactions in the most simple, accurate, time and cost effective manner in multiple modes. The service removes operational dependency on you to execute transactions.<br><br>
       <h5>Products covered in NJ E-Wealth</h5>
       <ul>
         <li>All exchange traded Mutual Fund Schemes</li>
         <li>Exchange Traded Funds or ETFs</li>
         <li>Direct equity stocks traded on exchange</li>
       </ul>
       <h5>Transaction Mode Options in NJ E-Wealth</h5>
       <ul>
         <li>Online desk transaction - transact from NJ Trading Account desk</li>
         <li>Call & Transact - transact by calling us on a help-line</li>
         <li>Offline /Physical instruction - transact using the physical instruction slip /form</li>
       </ul>
       <h5>Unique Features:</h5>
       <ul>
         <li>Online transaction options in mutual funds include Purchase, Redemptions, SIP, STP and even inter-AMC switches</li>
         <li>SIP option in Equity stocks and ETFs</li>
         <li>Multiple options of payment remittance for lumsum purchase using online mode, including Net Banking and Debit Cards</li>
         <li>Payment collection through ECS & Auto debit Facility for mutual fund SIP</li>
         <li>Any-Time, Any Where Access through online Trading Desk, Mobile Desk & Mobile Application</li>
       </ul>
