    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          ...
          <a class="nav-link dropdown-item active" href="mars.php"><strong>MARS</strong></a>
     ...
     <div class="container" style="background-color: white;">
        ...
        <div >
          <br>
          <div>You are here:  <a class="unorder" href="#">Home</a> / <a class="unorder" href="#">Products</a> / MARS</div>
        ...
        <!-- slider start -->
            ...
            <h3>Why MARS (Mutual Fund Automated Re-balancing System)?</h3><hr>
            <ul class="unorder">
              <li > Every investor while investing wishes to maximise his returns while minimising his risk. MARS gives investors access to a range of well diversified portfolios to choose from.</li>
              <li> There are 2 broad sets of asset allocation portfolios in MARS :<br>

                  <div style="margin-left: 25px;"> <strong >1. Dynamic Asset Allocation:</strong>   the asset allocation between equity and debt would vary depending on the risk in the equity markets; higher the risk, lower will be the allocation into equities and vice versa.</div>
                  <div style="margin-left: 25px;"><strong>2. Fixed Asset Allocation:</strong>   the asset allocation between equity and debt will be kept fixed.</div> 
                  
              </li>
              <li> The underlying MF schemes will be selected by the NJ Research Team.</li>
              <li> The asset allocation re-balancing would be done yearly for Fixed Asset Allocation and half-yearly for Dynamic Asset Allocation.</li>
              <li> The MARS portfolios are only available to investors holding E-Wealth account.</li>
            </ul>
            <strong>Key Benefits of MARS :</strong> 
            <ul class="unorder">
              <li> Investor can select a model portfolio depending on his requirements and investment needs.</li>
              <li> Helps the investor to invest in well researched mutual fund schemes in his portfolio.</li>
              <li> Simple execution tools for portfolio rebalancing.</li>
              <li> Enhanced returns resulting from disciplined asset allocation.</li>
            </ul><hr>
            <img style="height: 400px;width: 550px;" src="pics\mars3.jpg">
            <img style="height: 400px;width: 550px;" src="pics\mars1.jpg">
            <img style="height: 400px;width: 550px;" src="pics\mars2.jpg">
          </div>
          <div ></div>
        </div>
