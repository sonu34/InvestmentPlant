  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
     ...
     <div class="container" style="background-color: white;">
        ...
        <div >
          <br>
          <div>You are here:  <a class="unorder" href="index.php">Home</a> / <a class="unorder" href="#">Products</a> / <a class="unorder" href="insurance.php">Insurance</a> / Get Quotation</div>
...
<footer class="mainfooter" role="contentinfo">
        ...
        <div class="sidebar-contact">
         ...
         <form>
           ...
           <input type="rel" name="snumber" placeholder ="Phone Number" required>
