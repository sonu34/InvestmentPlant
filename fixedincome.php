    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown active">
       ...
       <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          ...
          <div class="dropdown-divider"></div>
          <a class="nav-link dropdown-item active" href="fixedincome.php"><strong>Fixed Deposits</strong> </a>
          <div class="dropdown-divider"></div>
     ...
     <div class="container" style="background-color: white;">
        ...
        <div >
          <br>
          <div>You are here:  <a class="unorder" href="#">Home</a>/ <a class="unorder" href="#">Products</a> / Fixed Deposits</div>
        ...
        <div class="row">
          <div class="col-lg-8">
            ...
            <h3>Fixed Deposits</h3><hr>
            <h6>Following Company Fixed Deposits are currently available through us:</h6><hr>
            <img style="height: 800px; width: 800px;" src="pics\hd.jpg"><hr>
            <img style="height: 700px; width: 800px;" src="pics\bajaj.jpg"><hr>
            <img style="height: 800px; width: 800px;" src="pics\shriram.jpg">
          </div>
