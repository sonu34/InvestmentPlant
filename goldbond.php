    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          ...
          <div class="dropdown-divider"></div>
          <a class="nav-link dropdown-item active" href="goldbond.php"><strong>RBI Gold</strong> </a>
          <div class="dropdown-divider"></div>
     ...
     <div class="container" style="background-color: white;">
        ...
        <div >
          <br>
          <div>You are here:  <a class="unorder" href="#">Home</a> / <a class="unorder" href="#">Products</a> / RBI Gold</div>
        ...
        <div class="row">
          <div class="col-lg-9">
            ...
            <h3>Sovereign RBI Gold Scheme</h3><hr>
             We indians love to invest in gold beyond its market value. Now there are ways to own gold without inherent risks or bearings making charges. The investors will be compensated at a fixed rate of 2.50% intrest per annum payable semi-annually on the nominal value of investment.<br>
Sovereign Gold Bond is one such alternative, issued by RBI on behalf of the Government of India. Here, you can own 24k pure gold in 'certificate' formate in your E-Wealth account. The minimum initial investment is 1 gram of gold, and the upper limit is 4 kgs of gold per investor(individual and HUF) per fiscal (April-March). For entities such as trusts and universities, 20 kgs of gold are permissible per fiscal (April-March).<br><br>
             
             <strong>Key advantages of Sovereign Gold Bond :</strong> <br>
             <div >
              <div >
                <ul class="unorder" style="float: left;">
                  <li> Absolute safety</li>
                  <li> Extra Income</li>
                  <li> Indexation Benefit</li>
                </ul>
              </div>
               <div >
                 <ul class="unorder" style="margin-left:40%;">
                   <li> Tradability</li>
                   <li> Collateral against secured lones</li>
                   <li> Risks and costs of storage eliminated</li>
                 </ul>
               </div>
             </div><br>
            <strong>Comparing Sovereign Gold Bond with Physical gold & Gold ETFs :</strong>
            <img style="height: 550px;width: 700px;" src="pics\sgb.jpg"> <br><br>
            In short, Sovereign Gold Bonds are new-age investment vehicles for those interested in the gold sector. So, if the above description matches your financial goals, you can go for this.
            <img style="height: 850px;width: 900px;" src="pics\sgb2.jpg">
