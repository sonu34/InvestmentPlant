  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          ...
          <div class="dropdown-divider"></div>
          <a class="nav-link dropdown-item active" href="clientdeskinfo.php"><strong>Client Desk</strong></a>
        </div>  
    ...
    <div class="container" style="background-color: white;">
     ...
     <!-- slider start -->
        ...
        <br>
          <div>You are here:  <a class="unorder" href="#">Home</a> / <a class="unorder" href="#">Technology</a> / Client Desk</div>
        
        <hr>
     
       <h3>Client Desk</h3><hr>
       <h5>NJ Client Desk: “The Complete Family Wealth Management Solution”</h5>
       NJ Client Desk offers our clients with a comprehensive online desk, which consolidates entire wealth/ portfolio information for an entire family/ group at one place. It keeps the customers informed of their portfolio, anytime any where, and empowers them to take smart investment decisions.<br><br>
       The customers get access to virtually all financial and non-financial products to manage their portfolio. We can also create multiple customised groups /accounts for specific portfolio management needs of our clients. You can also maintain records of your investments with other advisors /distributors on the Client Desk to get a single consolidated view of your entire wealth.<br><br>
       <strong>Key features:</strong>
       <ul>
        <li>You can map your Financial Goals and track their progress</li>
         <li>Consolidated desk for recording entire portfolio information for group of investors /family</li>
         <li>Automatic transaction updates for all financial /non-financial products accessed through us</li>
         <li>Flexibility to add your Non-NJ portfolio (except mutual funds) personally or by giving rights to us</li>
         <li>Flexibility to create sub-groups /different accounts for different wealth management objectives</li>
         <li>Great choice of multiple consolidated and product specific reports</li>
         <li>Any-Time, Any Where Access through online Client Desk, Mobile Desk & Mobile Application</li>
       </ul>
