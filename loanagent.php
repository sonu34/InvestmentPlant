...
<body style="background-color: #DCF5FF">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          ...
          <div class="dropdown-divider"></div>
          <a class="nav-link dropdown-item active" href="loanagent.php"><strong>Loan Against Securities</strong></a>
        </div>
     ...
     <div class="container" style="background-color: white;">
        ...
        <div >
          <br>
          <div>You are here:  <a class="unorder" href="#">Home</a> / <a class="unorder" href="#">Products</a> / Loan Against Securities</div>
  ...
  <!-- slider start -->
        ...
        <!-- slider start -->
            ...
            <h3>Loan Against Securities</h3><hr>
            Why do we invest ?<br>
            <ul class="unorder">
              <li> Wealth Creation</li>
              <li> Achieve financial goals like child education & marriage.</li>
              <li> Retirement</li>
              <li> Fulfill Aspirations of life</li>
            </ul>
            There are few events in life where we need money for short term, Life events like :
            <ul class="unorder">
              <li> Hospitalization</li>
              <li> Buying a Car, TV, Bike, etc</li>
              <li> Home Renovation</li>
              <li> Family tour</li>
              <li> Emergency</li>
            </ul>
            What we generally do ?<br>
            We redeem our investments to fulfil our short-term needs.<br><br>
            <p style="color: blue;" >Is this the right decision ??</p>
            <p style="color: red;">No…No…</p><br>
            We miss Wealth creation and Goal Achievement opportunity and we miss out reinvestment opportunity.<br>
            Is there any solution where we stay invested and still fulfill our short term financial needs ?<br>  
            Loan Against Securities<br>
            Get loans against your investments in Mutual Fund & Stocks.
            <img class="imge" style="width: 550px;height: 750px;" src="pics\las1.jpg">
            <img style="width: 950px;height: 550px;" src="pics\las2.jpg">



          </div>
          <div ><br><br>
            <img style="width: 360px;height: 240px;" src="pics\las2.jpg">
          </div>
        </div>
