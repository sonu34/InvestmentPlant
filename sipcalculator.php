  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown  active">
        ...
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          <a class="nav-link dropdown-item active" href="sipcalculator.php" ><strong>MF SIP Calculator</strong></a>
          <div class="dropdown-divider"></div>
    ...
    <div style="background-color: white;" class="container">
    	<div >
          <br>
          <div>You are here:  <a class="unorder" href="#">Home</a> / <a class="unorder" href="#">Technology</a> / SIP Calculator</div><hr>
       ...
       <hr>
        ...
        <div class="col-sm-6">
            ...
            <div class="form-group">
               ...
               <div class="form-group">
                <div> How much your SIP amount?</div>
                <div class="input-group mb-2">
                  <div class="input-group-prepend">
                    <div class="input-group-text">₹</div>
                  </div>
                  <input type="number"  class="form-control" id="sipamount" placeholder="Amount..">
                </div>
              </div>
               ...
               <div class="form-group">
                <div>Investment Period</div>
                  ...
                  <input type="number"  class="form-control" id="years" placeholder="No. of Years..">
              </div>
              
              <div class="form-group">
                <div>What rate of return do you expect p.a.?</div>
                
                  <input type="number"  min="0" max="100" value="12" step="1" class="form-control" id="annualrate" placeholder="ex-12%">
              </div>
               
              
                
              <div class="form-group">
                <button class="btn btn-success mb-2" onclick="compute()">Calculate</button>
              </div>
            </div>
       </form>
        </div>
        <div class="col-sm-6">
            <h2 id="futureValue"></h2>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var investment = $('#sipamount').val(); // Total investment
    var years = $('#years').val(); // No of years
    var annualRate = $('#annualrate').val(); // annual Rate
