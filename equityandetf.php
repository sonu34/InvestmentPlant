    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          ...
          <div class="dropdown-divider"></div>
          <a class="nav-link dropdown-item active" href="equityandetf.php"><strong>Equity & ETFs</strong> </a>
          <div class="dropdown-divider"></div>
     ...
     <div class="container" style="background-color: white;">
        ...
        <div >
          <br>
          <div>You are here:  <a class="unorder" href="#">Home</a> / <a class="unorder" href="#">Products</a> / Equity & ETFs</div>
        ...
        <div class="row">
          <div class="col-lg-9">
            ...
            <h3>Equity & ETFs</h3><hr>
            We also offer our clients with NJ E-Wealth A/c services through one of the India's leading & highly reputed distribution houses. With the same you will have easy access to capital market products of direct equity stocks, Stock SIP and Exchange Traded Funds (ETFs).<br><br>
            <h4>Why Equities?</h4>
            <ul class="unorder">
              <li> One of the best avenues to beat inflation</li>
              <li> Long term wealth creation</li>
              <li> One of the most Liquid investment options</li>
              <li> Benefit from the <strong><font style="color: blue;">Power of Compounding</font></strong></li>
            </ul>
            <br>
        ...
        <div class="row">
          <div class="col-sm-6">
            <img style="height: 350px;width: 500px;float: left;" src="pics\equity1.jpg">
          </div>
          <div class="col-sm-6">
            <img style="height: 350px;width: 500px; padding: 25px 25px;" src="pics\equity.jpeg">
          </div>
        </div><br><br>
        <img style="height: 630px;width: 1027px;" src="pics\equity2.jpg">
        <br><br>
     </div>
